...
export function Feed() {
  ...
  return (
    <div className="flex-1 max-w-2xl border-x border-border min-h-screen bg-white pb-20">
      ...
      <div className="divide-y divide-border">
        ...
        {!isLoading && (
          <div className="p-12 text-center space-y-2 bg-muted/5">
            ...
            <p className="text-sm text-muted-foreground">Follow more traders to see more activity in your feed.</p>
