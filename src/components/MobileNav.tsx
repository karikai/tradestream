...
export function MobileNav() {
  ...
  return (
    <>
      ...
      <button className="sm:hidden fixed bottom-20 right-4 h-14 w-14 rounded-full bg-primary text-white shadow-lg shadow-primary/40 flex items-center justify-center z-50 hover:scale-105 active:scale-95 transition-transform">
